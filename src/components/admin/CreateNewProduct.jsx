...
const createnewProduct = () => {
  ...
  return (
    <div className={style.createnew}>
      <form className={style.createnew__form} onSubmit={submitHandler} encType="multipart/form-data">
        ...
        <div className={style.createnew__form__image}>
          ...
          <div className={style.createnew__form__image__preview}>
            {imagesPreview.map(img => (
              <img src={img} key={img} alt="Images Preview" className={style.createnew__form__image__preview__size} />
            ))}
          </div>
        </div>
