...
export const DropdownIndicatorUp = Template.bind({});
export const DropdownIndicatorDown = Template.bind({});
...
DropdownIndicatorUp.args = { name: 'dropdown-indicator-up' };
DropdownIndicatorDown.args = { name: 'dropdown-indicator-down' };
