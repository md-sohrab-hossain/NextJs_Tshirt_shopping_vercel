    ...
    <>
      ...
      <div className="productDetails">
            ...
            {images &&
              images.map((img, indx) => (
                <Carousel.Item key={img.public_id}>
                  <div key={indx} className="slider">
                    <img src={img.url} alt={product?.name} className="slider__img" />
                  </div>
                </Carousel.Item>
              ))}
          </Carousel>
        ...
        <div className="productDetails__info">
          <div className="productDetails__info__card">
            <h2 className="productDetails__info__card__name">{name}</h2>

            <b> BDT {price}/=</b>

            <div className="productDetails__info__card__description">{description}</div>
            <div className="productDetails__info__card__quantity">
              <span>Quantity:</span>
            ...
            <div className="productDetails__info__card__ratings">
              <div className="ratingOuter">
                <div className="ratingInner" style={{ width: `${(ratings / 5) * 100}%` }}></div>
              </div>
              <span id="#review">({numOfReviews} Reviews)</span>
            </div>

            <hr />

            <button
              className={loading ? 'productDetails__info__card__buttonWait' : 'productDetails__info__card__button'}
              onClick={handleOrder}
            >
